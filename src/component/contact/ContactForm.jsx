...
const ContactForm = () => {
  ...
  const onSubmit = (data) => {
    const subject = encodeURIComponent("New Message from A1 Elite");
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-xl mx-auto p-4 my-20">
        {/* Name and Email same line */}
        <div className="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-4 md:space-y-0">
          <div className="flex-1">
      ...
      {successMessage && (
        <p className="max-w-xl mx-auto text-green-500 text-center mt-4">{successMessage}</p>
      )}
    </>
  );
};
